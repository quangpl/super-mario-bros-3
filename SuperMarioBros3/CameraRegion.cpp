...
void CameraRegion::SetBoundary(RectBox value)
{
    this->boundary = value;
}

RectBox CameraRegion::GetBoundary()
{
...
void CameraRegion::SetInsideBoundary(RectBox value)
{
    this->inside = value;
}

RectBox CameraRegion::GetInsideBoundary()
{
    return inside;
}
